...
We use Recursive Feature Elimination (RFE) for automated feature selection:
...
## Conclusion
In conclusion, we found optimal subset of predictors using RFE consisting of four predictors: raw_timestamp_part_1, num_window, roll_belt, and yaw_belt. A RF model was developed using this subset.
